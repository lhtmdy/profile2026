    ...
    <!-- https://blog.avada.io/css/card-hover-effects -->
        <div class="card group overflow-hidden">
            <div class="image aspect-w-1 aspect-h-1 overflow-hidden">
                <img :src="info.image"
                    class="object-cover transition-[.5s] group-hover:translate-x-[00%] group-hover:opacity-50">
            </div>
            <div class="details">
...
.card .details {
    @apply absolute top-0 w-[85%]  h-full bg-primary-01 transition-[.5s] ease-in-out;
